...
export default class Api extends React.Component<any, any> {
  ...
  public render() {
    ...
    return <div>
      ...
      &nbsp;
      <a href="https://jupyterhub.readthedocs.io/en/latest/_static/rest-api/index.html" target="_blank">Doc1</a>
      &nbsp;
      <a href="https://jupyterhub.readthedocs.io/en/stable/api/index.html" target="_blank">Doc2</a>
      <hr/>
      <form>
        <div>
